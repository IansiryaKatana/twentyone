  ...
  return (
    <section aria-label="Contact" className="bg-[var(--nh-black)]">
      <div className="grid w-full grid-cols-1 md:grid-cols-12 md:items-stretch">
        {/* Red CTA panel — stretches to match form height */}
        <div className="relative flex min-h-[28rem] flex-col justify-between overflow-hidden bg-[var(--nh-red)] px-5 py-12 md:col-span-5 md:min-h-full md:px-10 md:py-14 lg:px-12">
          <Reveal className="relative z-10">
            <h2 className="font-display max-w-[14ch] text-[clamp(2.75rem,5vw,5.25rem)] font-semibold leading-[0.88] tracking-tighter text-white">
        ...
        {/* Contact form */}
        <div className="flex flex-col bg-[var(--nh-panel)] px-5 py-14 md:col-span-7 md:min-h-full md:px-10 md:py-16 lg:px-12">
          <Reveal>
